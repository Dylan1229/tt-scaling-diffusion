...
def main() -> None:
        ...
        for target in targets:
            for alpha in alphas:
                ...
                if sp > best["sp"]:
                    ...
                    print(f"[NEW BEST Spearman] {tag:<55} sp={sp:.4f}  winner={wm}/15  top5={ov:.4f}", flush=True)
                if wm > best["wm"] or (wm == best["wm"] and sp > best["wm_tb"]):
                    best["wm"] = wm; best["wm_tb"] = sp; best["wm_row"] = summary
                    print(f"[NEW BEST Winner ] {tag:<55} winner={wm}/15  sp={sp:.4f}  top5={ov:.4f}", flush=True)
    ...
    md_lines = [
        ...
        f"- winner   = {sp_row['avg_vbench_z_winner_match']}/15",
        ...
        f"- winner   = {wm_row['avg_vbench_z_winner_match']}/15",
